    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)!= PackageManager
            ...
            new SweetAlertDialog(this, SweetAlertDialog.WARNING_TYPE)
                    .setTitleText("Camera Permission")
                    .setContentText("Scanning bar code needs camera permission, please confirm to" +
                            " use camera!")
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Jump back
                        Intent jumpToMainIntent = new Intent();
                        jumpToMainIntent.putExtra(BarcodeScanner.EXTRA_BARCODE, message);
                        setResult(RESULT_OK, jumpToMainIntent);
                        finish();
                    }
                })
